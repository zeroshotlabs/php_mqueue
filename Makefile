...
all: $(LIB_DIR)/$(FINAL_NAME).so


$(LIB_DIR)/$(FINAL_NAME).so: $(OBJS) $(LIBPHPHI_DIR)/lib/libphphi.o
	@echo -e "\n\n=== Linking $(FINAL_NAME).so..."
	$(CC) $(LDFLAGS) -o $@ $(OBJS) $(LIBPHPHI_DIR)/lib/libphphi.o -ldl -lrt
